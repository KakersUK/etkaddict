...
|
*/
$allowed_domains = array('www.etkaddict.com', 'dev.etkaddict.com');
$default_domain  = 'www.etkaddict.com';
...
*/
$config['raven_client'] = array(getenv('RAVEN_CLIENT'));
$config['raven_config'] = array(getenv('RAVEN_CONFIG'));
$config['raven_log_threshold'] = array(getenv('RAVEN_LOG_THRESHOLD'));
$config['raven_environments'] = array(getenv('RAVEN_ENVIRONMENTS'));